...
public class RecipeMap {
    ...
    public static final List<QuantumMinerRecipe> MinerRecipeList = new ArrayList<>(List.of(
            ...
            new QuantumMinerRecipe(Cti.getResource("copper_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("minecraft:copper_ore")), 20),
                    1.8f),


            new QuantumMinerRecipe(Cti.getResource("gold_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("minecraft:gold_ore")), 10),
                    1.1f),
            new QuantumMinerRecipe(Cti.getResource("osmium_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("mekanism:osmium_ore")), 12),
                    1.21f),
            new QuantumMinerRecipe(Cti.getResource("iron_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("minecraft:iron_ore")), 12),
                    1.25f),
            new QuantumMinerRecipe(Cti.getResource("coal_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("minecraft:coal_ore")), 36),
                    1.5f),
            new QuantumMinerRecipe(Cti.getResource("diamond_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("minecraft:diamond_ore")), 6),
                    1.25f),
            new QuantumMinerRecipe(Cti.getResource("glowstone_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("minecraft:glowstone")), 6),
                    1.6f),
            new QuantumMinerRecipe(Cti.getResource("redstone_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("minecraft:redstone_ore")), 12),
                    1.15f),
            new QuantumMinerRecipe(Cti.getResource("lapis_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("minecraft:lapis_ore")), 12),
                    1.15f),
            new QuantumMinerRecipe(Cti.getResource("silver_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("thermal:silver_ore")), 10),
                    1.45f),
            new QuantumMinerRecipe(Cti.getResource("nickel_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("thermal:nickel_ore")), 12),
                    1.05f),

            new QuantumMinerRecipe(Cti.getResource("emerald_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("minecraft:emerald_ore")), 12),
                    1.15f),
            new QuantumMinerRecipe(Cti.getResource("tin_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("thermal:tin_ore")), 10),
                    1.45f),
            new QuantumMinerRecipe(Cti.getResource("lead_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("thermal:lead_ore")), 12),
                    1.05f),
            new QuantumMinerRecipe(Cti.getResource("aluminium_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("immersiveengineering:ore_aluminum")), 12),
                    1.65f),

            new QuantumMinerRecipe(Cti.getResource("calorite_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("ad_astra:venus_calorite_ore")), 10),
                    0.55f),
            new QuantumMinerRecipe(Cti.getResource("desh_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("ad_astra:moon_desh_ore")), 12),
                    0.75F),
            new QuantumMinerRecipe(Cti.getResource("ostrum_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("ad_astra:mars_ostrum_ore")), 12),
                    0.75F),

            new QuantumMinerRecipe(Cti.getResource("zirconium_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("tinkers_reforged:titanium_ore")), 12),
                    0.95f),
            new QuantumMinerRecipe(Cti.getResource("ttan_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("tinkerscalibration:titanium_ore")), 8),
                    0.95F),


            new QuantumMinerRecipe(Cti.getResource("neutronium_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("kubejs:overdense_neutronium_ore")), 4),
                    0.2F),

            new QuantumMinerRecipe(Cti.getResource("bismuthinite_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("etshtinker:bismuthinite_ore_deepslate")), 6),
                    1.2f),
            new QuantumMinerRecipe(Cti.getResource("cobalt_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("tconstruct:cobalt_ore")), 6),
                    1.35f),
            new QuantumMinerRecipe(Cti.getResource("debris_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("minecraft:ancient_debris")), 6),
                    0.75f),
            new QuantumMinerRecipe(Cti.getResource("quartz_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("minecraft:nether_quartz_ore")), 8),
                    1.3F),
            new QuantumMinerRecipe(Cti.getResource("zinc_ore_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("create:zinc_ore")), 10),
                    1.7F),
            ...
            new QuantumMinerRecipe(Cti.getResource("ingot_uranium_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("mekanism:uranium_ore")), 16),
                    1.7F),
            new QuantumMinerRecipe(Cti.getResource("moon_cheese_ore_quantum"),
                    new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("ad_astra:moon_cheese_ore")), 10),
                    0.75F)
     ...
     * 注：修改非特殊采集面板的配方没有任何意义，破坏面板和陨铁面板的配方只用于JEI显示。
