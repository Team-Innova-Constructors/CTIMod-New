...
public class RedSparkParticle extends TextureSheetParticle {
    public static RedSparkParticle.Provider provider(SpriteSet spriteSet) {
        return new RedSparkParticle.Provider(spriteSet);
    }
    public double xdo;
    public double ydo;
    public double zdo;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            return new RedSparkParticle(pLevel,pX,pY,pZ,pXSpeed,pYSpeed,pZSpeed,this.sprites);
        }
    }
}
