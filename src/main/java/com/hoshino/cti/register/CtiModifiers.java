...
public class CtiModifiers {
    ...
    public static final StaticModifier<SlashColorize> SLASH_COLORIZE = MODIFIERS.register("slash_colorize", SlashColorize::new);
    ...
    public static final StaticModifier<Immortal> IMMORTAL_STATIC_MODIFIER = MODIFIERS.register("immortal", Immortal::new);
