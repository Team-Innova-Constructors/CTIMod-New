...
public enum DynamicColorEnum {
    ...
    @Getter private final int[] colorArray;

    @Getter private final int scrollSteps;
    @Getter private final int scrollDelayMs;

    @Getter private final int breathSteps;
    @Getter private final int breathCycleMs;
    @Getter private final float minBrightness;
    ...
    public Component buildComponent(String textKey, @Nullable String append, boolean isTranslatable) {
        return switch (this.type) {
            ...
            case REMIX -> DynamicComponentUtil.BreathAndScrollColorfulText.getColorfulText(
                    textKey, append, this.colorArray,
                    this.scrollSteps, this.scrollDelayMs,
                    this.breathSteps, this.breathCycleMs, this.minBrightness,
                    isTranslatable
            );
        };
    }
